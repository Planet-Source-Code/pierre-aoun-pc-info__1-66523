...
Option Explicit
Public UserNN As String
Public NomPrenom As String
...
Public Function Ping(ByVal Address As String, RoundTripTime As String, DataMatch As Boolean, Optional DataSize As Long = 32, Optional TimeOut As Long = PING_TIMEOUT) As Long
